...
public class Initiator implements BundleActivator {
	...
	public void createInformationSystem(){		
		try {
			bundle = context.getBundle("file:C:/Users/Tobi/workspace/plugins/rwi.infosystem.is_1.0.0.201210172000.jar");
			if(bundle==null)
				bundle = context.installBundle("file:C:/Users/Tobi/workspace/plugins/rwi.infosystem.is_1.0.0.201210172000.jar");
			bundle.start();
